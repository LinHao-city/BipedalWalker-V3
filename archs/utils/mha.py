...
if __name__ == "__main__":
    ...
    # 使用当前文件中定义的MultiHeadAttention类
    selfattn = MultiHeadAttention(input_size, hidden_size, num_of_attention_heads)
    print(selfattn)

    # 创建随机输入进行测试
    embed_rand = torch.rand((1, 3, input_size))  # [batch_size, seq_length, input_size]
