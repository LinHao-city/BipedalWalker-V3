...
try:
    ...
    from ..utils.noise import OrnsteinUhlenbeckNoise, DecayingOrnsteinUhlenbeckNoise, GaussianNoise, DecayingGaussianNoise, DecayingRandomNoise
except ImportError:
    # 当从scripts目录运行时的绝对导入
    import sys
